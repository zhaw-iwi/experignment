...
$checks = [
    ...
    ['label' => 'credit percentage below target', 'actual' => credit_percentage(5.4, 8.0), 'expected' => 67.5],
    ['label' => 'credit percentage above target', 'actual' => credit_percentage(9.0, 8.0), 'expected' => 112.5],
    ['label' => 'credit percentage without target', 'actual' => credit_percentage(9.0, null), 'expected' => null],
    ['label' => 'credit percentage with zero target', 'actual' => credit_percentage(9.0, 0.0), 'expected' => null],
